<template>
  <div class="dragContainer">
    <div class="slide">
      <div id="list" @mousedown="dragListMouseDown" class="grid">
        <img
          class="item"
    ...
    <div id="content" @mouseup="dragContentMouseUp"></div>
  </div>
</template>
...
// 改变漂浮元素（合并多个操作）
const moveFlutter = function (x, y, d = 0) {
...
const changeStyle = function (arr) {
...
// 计算两点之间距离
const distance = function ({ clientX, clientY }) {
...
const simulate = function (url, flag) {
...
const randomNum = function randomNum(n, m) {
